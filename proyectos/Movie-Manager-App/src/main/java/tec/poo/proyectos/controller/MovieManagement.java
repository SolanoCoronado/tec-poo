...
import tec.poo.proyectos.view.MovieManagerView;
...
public class MovieManagement {
    ...
    public MovieManagement() {
        ...
        Movie movie1 = new Movie("Piratas del caribe", "Action", -1,"Megusta mucho","PelisMas");
        Movie movie2 = new Movie("Cars", "Action", 3,"","");
        Movie movie3 = new Movie("Conjuro 2", "horror", 3,"No da miedo","Wiki");
    ...
    public void showGui() {
        EventQueue.invokeLater(() -> {
            MovieManagerView frame = new MovieManagerView(movies);
